...
variable "reasoning_models" {
  type    = list(string)
  default = [
    "us.anthropic.claude-3-7-sonnet-20250219-v1:0", //"us.anthropic.claude-sonnet-4-20250514-v1:0"
  ]
}
...
variable "model_main" {
  ...
  default = {
    id          = "us.anthropic.claude-3-7-sonnet-20250219-v1:0", //"us.anthropic.claude-sonnet-4-20250514-v1:0"
    max_tokens  = 64000
  }
}
