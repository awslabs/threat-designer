...
class TestCreateDynamoDBItem:
    ...
    def test_creates_item_with_correct_structure(self, mock_datetime, mock_boto3_resource):
    ...
    @patch('utils.utils.boto3.resource')
    @patch('utils.utils.datetime')
    def test_raises_exception_on_dynamodb_error(self, mock_datetime, mock_boto3_resource):
