...
export default defineConfig(({ mode }) => {
  ...
  if (isLightningMode) {
    ...
    try {
      ...
      console.warn('vite-plugin-node-polyfills not found. Install it for Lightning Mode: npm install -D vite-plugin-node-polyfills');
    }
    ...
    config.resolve.alias = {
      ...
      'node:child_process': path.resolve(__dirname, './embedded-backend/src/stubs/child_process.js'),
      ...
      '@aws-sdk/credential-provider-node': path.resolve(__dirname, './embedded-backend/src/stubs/empty.js'),
      '@aws-sdk/credential-provider-process': path.resolve(__dirname, './embedded-backend/src/stubs/empty.js'),
      '@aws-sdk/credential-provider-ini': path.resolve(__dirname, './embedded-backend/src/stubs/empty.js'),
      '@aws-sdk/credential-provider-env': path.resolve(__dirname, './embedded-backend/src/stubs/empty.js'),
      '@aws-sdk/credential-provider-sso': path.resolve(__dirname, './embedded-backend/src/stubs/empty.js'),
